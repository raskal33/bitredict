...
export const CONTRACT_ADDRESSES = {
  ...
  POOL_CORE: (process.env.NEXT_PUBLIC_POOL_CORE_ADDRESS || '0x3A6AFdC8C9c0eBe377B5413e87F1005675bbA413') as `0x${string}`,
  BOOST_SYSTEM: (process.env.NEXT_PUBLIC_BOOST_SYSTEM_ADDRESS || '0x36fddb1844B89D4c0A00497A1C6B56B958bCcFB6') as `0x${string}`,
  COMBO_POOLS: (process.env.NEXT_PUBLIC_COMBO_POOLS_ADDRESS || '0xA92F8C59fd9a2445ef0200f0808e10BB3f00e549') as `0x${string}`,
  FACTORY: (process.env.NEXT_PUBLIC_FACTORY_ADDRESS || '0xf669C348a37cc88790A590571CFBe8983A14D784') as `0x${string}`,
  ...
  BITREDICT_POOL: (process.env.NEXT_PUBLIC_BITREDICT_POOL_ADDRESS || '0x3A6AFdC8C9c0eBe377B5413e87F1005675bbA413') as `0x${string}`,

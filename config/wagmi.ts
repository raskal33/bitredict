...
export const CONTRACT_ADDRESSES = {
  // Core Contracts (LATEST DEPLOYMENT - October 2, 2025)
  BITR_TOKEN: (process.env.NEXT_PUBLIC_BITR_TOKEN_ADDRESS || '0x67aa1549551ff4479B68F1eC19fD011571C7db10') as `0x${string}`,
  POOL_CORE: (process.env.NEXT_PUBLIC_POOL_CORE_ADDRESS || '0x59210719f4218c87ceA8661FEe29167639D124bA') as `0x${string}`,
  BOOST_SYSTEM: (process.env.NEXT_PUBLIC_BOOST_SYSTEM_ADDRESS || '0xe3fA1B9ECbbB14A871fd78c76c5b11a6BA22D385') as `0x${string}`,
  COMBO_POOLS: (process.env.NEXT_PUBLIC_COMBO_POOLS_ADDRESS || '0x6C5dAae65bA514720661E046caaDf674755b63E7') as `0x${string}`,
  FACTORY: (process.env.NEXT_PUBLIC_FACTORY_ADDRESS || '0x7DBD027177379188882a09d0c42E49F40b96221b') as `0x${string}`,
  
  // Oracle Contracts
  GUIDED_ORACLE: (process.env.NEXT_PUBLIC_GUIDED_ORACLE_ADDRESS || '0x194e3CBFC5e1ff4323264cDb72fd6232c3131a40') as `0x${string}`,
  ...
  // System Contracts
  REPUTATION_SYSTEM: (process.env.NEXT_PUBLIC_REPUTATION_SYSTEM_ADDRESS || '0xBE8fe32C3f4dA12591869744b63ca828c64Ee981') as `0x${string}`,
  ...
  ODDYSSEY: (process.env.NEXT_PUBLIC_ODDYSSEY_ADDRESS || '0xD9E1f0c0D1105B03CE3ad6db1Ad36a4909EE733C') as `0x${string}`,
  
  // Legacy support (for backward compatibility) - UPDATED TO NEW ADDRESSES
  BITREDICT_POOL: (process.env.NEXT_PUBLIC_BITREDICT_POOL_ADDRESS || '0x59210719f4218c87ceA8661FEe29167639D124bA') as `0x${string}`,

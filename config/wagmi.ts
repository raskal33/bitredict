...
// Contract addresses for smart contract integration - UPDATED WITH LATEST DEPLOYMENT
export const CONTRACT_ADDRESSES = {
  // Core Contracts (LATEST DEPLOYMENT)
  BITR_TOKEN: (process.env.NEXT_PUBLIC_BITR_TOKEN_ADDRESS || '0x67aa1549551ff4479B68F1eC19fD011571C7db10') as `0x${string}`,
  POOL_CORE: (process.env.NEXT_PUBLIC_POOL_CORE_ADDRESS || '0x35aC19f06eD1E2E19bbB2d174EB006B54d36ab1E') as `0x${string}`,
  BOOST_SYSTEM: (process.env.NEXT_PUBLIC_BOOST_SYSTEM_ADDRESS || '0x8e0901FEb2b8624846d11d2c3DAd387eF105AC75') as `0x${string}`,
  COMBO_POOLS: (process.env.NEXT_PUBLIC_COMBO_POOLS_ADDRESS || '0xA0E3F88fBFd3a670661ae858a2B64E4b18DaADC8') as `0x${string}`,
  FACTORY: (process.env.NEXT_PUBLIC_FACTORY_ADDRESS || '0xC8aD32a9a5c0da20f1c55Be8fe0f4dd64E65e490') as `0x${string}`,
  ...
  // System Contracts
  REPUTATION_SYSTEM: (process.env.NEXT_PUBLIC_REPUTATION_SYSTEM_ADDRESS || '0x52D75c543f6bf0C576ca9058669610108611Cd95') as `0x${string}`,
  ...
  BITREDICT_POOL: (process.env.NEXT_PUBLIC_BITREDICT_POOL_ADDRESS || '0x35aC19f06eD1E2E19bbB2d174EB006B54d36ab1E') as `0x${string}`, // Updated to new address
